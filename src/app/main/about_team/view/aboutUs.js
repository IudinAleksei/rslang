...
const generatePageAboutUs = () => {
  ...
  divAboutUs.insertAdjacentHTML('afterbegin', logo);
  ...
  for (let i = 0; i < param.length; i += 1) {
    divWrapCards.insertAdjacentHTML('afterbegin', card(param[i].img, param[i].name, param[i].text, param[i].telegramLink, param[i].githubLink));
  }
};
