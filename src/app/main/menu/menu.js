...
function onClickBurgerIcon() {
  document.querySelector('.menu__icon').classList.toggle('menu_active');
  document.querySelector('.menu-bg').classList.toggle('menu__bg_active');
  document.querySelector('.menu__items').classList.toggle('menu_active');
}

function removeActiveStateFromBurger() {
  document.querySelector('.menu-bg').classList.remove('menu__bg_active');
  document.querySelector('.menu__icon').classList.remove('menu_active');
  document.querySelector('.menu__items').classList.remove('menu_active');
}
